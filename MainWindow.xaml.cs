//------------------------------------------------------------------------------
//   Made by Priyank Trivedi
//   This application allowes you to record all the data stream (RGB, Depth & Skeleton Data) to the HDD 
//   Kinect and all the relevent images are Copyright (c) of Microsoft Corporation.  All rights reserved.
//   This code is available under MIT Licency
//------------------------------------------------------------------------------
...
namespace KinectRecord
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        {
            if(rgb_view.Visibility == Visibility.Hidden)
            {
                rgb_view.Visibility = Visibility.Visible;
                skel_view.Visibility = Visibility.Visible;
                depth_view.Visibility = Visibility.Visible;
